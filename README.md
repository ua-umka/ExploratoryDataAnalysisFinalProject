...
Final project for Exploratory Data Analysis course on Coursera (4th course of the data analysis specialization).
...
The data for this assignment are available [here](https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2FNEI_data.zip) as a compressed file [29Mb, 4 Mb bigger than can be download to git].
